"""
Launch full grasp demo: Gazebo + AnyGrasp detection + Pick-and-Place (5 DoF).
...
Usage:
    ...
    ros2 launch robot_5dof grasp_demo.launch.py test_scenario:=transparent_bottle
    ros2 launch robot_5dof grasp_demo.launch.py test_scenario:=flat_object
    ros2 launch robot_5dof grasp_demo.launch.py test_scenario:=dense_clutter
"""
...
def launch_setup(context, *args, **kwargs):
    pkg_share = FindPackageShare("robot_5dof")
    ...
    anygrasp_service_script = PathJoinSubstitution([
        FindPackagePrefix("robot_5dof"), "lib", "robot_5dof", "anygrasp_service.py"
    ])
