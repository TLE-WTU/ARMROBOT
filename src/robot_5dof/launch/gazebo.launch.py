"""
Launch Gazebo Harmonic with 5 DoF robot, controllers, and camera bridge.

Usage:
    ros2 launch robot_5dof gazebo.launch.py
    ros2 launch robot_5dof gazebo.launch.py world:=empty
"""
...
def generate_launch_description():
    ...
    robot_description_content = Command([
        ...
        PathJoinSubstitution([pkg_share, "urdf", "robot_5dof.urdf.xacro"]),
    ])
    robot_description = {
