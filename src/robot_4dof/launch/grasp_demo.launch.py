"""
Launch full grasp demo: Gazebo + AnyGrasp detection + Pick-and-Place (4 DoF).

Usage:
    # Default scenario (Mug, Duck, Torus):
    ros2 launch robot_4dof grasp_demo.launch.py

    # Benchmark failure scenarios:
    ros2 launch robot_4dof grasp_demo.launch.py test_scenario:=transparent_bottle
    ros2 launch robot_4dof grasp_demo.launch.py test_scenario:=flat_object
    ros2 launch robot_4dof grasp_demo.launch.py test_scenario:=dense_clutter
"""
...
def launch_setup(context, *args, **kwargs):
    pkg_share = FindPackageShare("robot_4dof")
    ...
    anygrasp_service_script = PathJoinSubstitution([
        FindPackagePrefix("robot_4dof"), "lib", "robot_4dof", "anygrasp_service.py"
    ])
